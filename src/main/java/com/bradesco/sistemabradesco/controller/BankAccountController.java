...
public class BankAccountController {
    ...
    @GetMapping("/{number}")
    public ResponseEntity<BankAccountDTO> findByNumero(@PathVariable int accountNumber){
    ...
    @GetMapping("/{agency}")
    public ResponseEntity<List<BankAccount>> findByAgencia(@PathVariable Integer agency){
