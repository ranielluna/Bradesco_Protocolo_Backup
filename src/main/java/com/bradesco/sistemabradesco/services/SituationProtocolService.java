...
public class SituationProtocolService {
    ...
    public SituationProtocol createSituationProtocol(SituationProtocolDTO situationProtocolDTO){
    ...
    /* Deletar Situacao protocolo */
     @Transactional
    public void deleteSituationProtocol(int codigo){
        situationProtocolRepository.deleteById(codigo);
    }
